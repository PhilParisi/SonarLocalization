...
start_indices = [2, 114, 205, 321, 468, 624, 912, 1058, 1181, 1329];  % start indices
end_indices = [70, 174, 289, 407, 556, 699, 1006, 1138, 1265, 1417];  % end indices
...
%% Difference between base case and Test 4
